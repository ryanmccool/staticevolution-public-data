...
class PublicExportBoundaryTests(unittest.TestCase):
    ...
    def test_export_does_not_request_removed_elsewhere_tables(self):
        self.assertNotIn("blog_elsewhereitem", export.TABLES)
        self.assertNotIn("blog_elsewhereitem_tags", export.TABLES)
        self.assertNotIn(
            "blog_elsewhereitem",
            " ".join(export.TABLES.values()),
        )
